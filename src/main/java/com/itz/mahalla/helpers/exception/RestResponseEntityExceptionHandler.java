package com.itz.mahalla.helpers.exception;

import com.itz.mahalla.helpers.configs.LoggerConfig;
import com.itz.mahalla.helpers.exception.custom.NotFoundException;
import com.itz.mahalla.helpers.exception.custom.ResourceNotFoundException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    protected @NotNull ResponseEntity<Object> handleNoHandlerFoundException(@NotNull NoHandlerFoundException ex, @NotNull HttpHeaders headers,
                                                                            @NotNull HttpStatus status, @NotNull WebRequest request) {
        // custom logic here
        loggerConfig.logger.error(ex.getMessage());
