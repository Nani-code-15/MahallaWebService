package com.itz.mahalla.use_cases.super_admin_module.page_master;
...
import com.itz.mahalla.persistence.models.super_admin_module.PageMaster;
import com.itz.mahalla.persistence.models.super_admin_module.TableButtonSchema;
import com.itz.mahalla.persistence.models.super_admin_module.TableMainSchema;
import com.itz.mahalla.use_cases.aaa_module.role_master.RoleMasterService;
import com.itz.mahalla.use_cases.aaa_module.role_master_permission.RoleMasterPermissionService;
import com.itz.mahalla.use_cases.super_admin_module.form_data.FormDataService;
import com.itz.mahalla.use_cases.super_admin_module.page_master.dao.PageMasterDao;
import com.itz.mahalla.use_cases.super_admin_module.page_master.dao.PageMasterIdDao;
import com.itz.mahalla.use_cases.super_admin_module.page_master.dao.PageMasterPojo;
import com.itz.mahalla.use_cases.super_admin_module.page_master.dao.RolePrmDao;
import com.itz.mahalla.use_cases.super_admin_module.table_button_schema.TableButtonSchemaService;
import com.itz.mahalla.use_cases.super_admin_module.table_button_schema.dao.TableButtonSchemaIdDao;
import com.itz.mahalla.use_cases.super_admin_module.table_main_schema.TableMainSchemaService;
import com.itz.mahalla.use_cases.super_admin_module.table_main_schema.dao.TableMainSchemaIdDao;
...
public class PageMasterController {
	...
	public ResponseEntity<?> masterSet(HttpServletRequest request, @RequestBody PageMasterDao getVal) throws Exception {
		...
		for (RoleMaster roleMaster : roleMasters) {
			...
			roleMasterPermission.setRoleMasterId(roleMaster.getId());
			roleMasterPermission.setPageMasterId(pageMasterId);
	...
	public ResponseEntity<?> masterDelete(HttpServletRequest request
		...
		//delete from data
		formDataService.delByParentId(pageMasterId);
	...
	public ResponseEntity<?> masterGetAllPageTableButtonById(HttpServletRequest request
		...
		RolePrmDao rolePrmDao = new RolePrmDao();
		rolePrmDao.setId(rolPrm.getId());
		rolePrmDao.setCreate(rolPrm.getDoCreate());
		rolePrmDao.setDelete(rolPrm.getDoDelete());
		rolePrmDao.setPageMasterId(rolPrm.getPageMasterId());
		rolePrmDao.setRead(rolPrm.getDoRead());
		rolePrmDao.setRoleMasterId(rolPrm.getRoleMasterId());
		rolePrmDao.setUpdate(rolPrm.getDoUpdate());
		...
		result.put("roleMasterPrm", rolePrmDao);
